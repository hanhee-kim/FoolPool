...
<%@include file="/WEB-INF/views/include/menubar.jsp" %>
			...
			<div class="pfDivLine">
				...
				<div class="pfFormArea">
					<form action="poolentarierEdit" method="post" enctype="multipart/form-data" id="poolentarierEdit">
								...
								<tr>
									<td>
										<input id="pfKeyword" type="text" placeholder="키워드 입력"
											name="keyword" onkeyup="characterCheck(this)" onkeydown="characterCheck(this)">
